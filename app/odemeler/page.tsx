...
// Mock data for development (only for guest users)
      ...
      <main className="container mx-auto px-4 py-8 space-y-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
          <Card className="bg-gradient-to-br from-primary/20 to-primary/5 border-primary/30 hover:shadow-xl transition-all duration-300 transform hover:-translate-y-1">
            ...
            <CardContent>
              <div className="text-2xl font-bold">{formatTRY(totalAmount)}</div>
              <p className="text-xs text-muted-foreground mt-1">{allPayments.length} ödeme</p>
            </CardContent>
          </Card>
          ...
          <Card className="bg-gradient-to-br from-orange-500/20 to-orange-500/5 border-orange-500/30 hover:shadow-xl transition-all duration-300 transform hover:-translate-y-1">
            ...
            <CardContent>
              <div className="text-2xl font-bold">{formatTRY(pendingAmount)}</div>
              <p className="text-xs text-muted-foreground mt-1">{pendingPayments.length} ödeme bekliyor</p>
            </CardContent>
          </Card>
          ...
          <Card className="bg-gradient-to-br from-green-500/20 to-green-500/5 border-green-500/30 hover:shadow-xl transition-all duration-300 transform hover:-translate-y-1">
            ...
            <CardContent>
              <div className="text-2xl font-bold">{formatTRY(paidAmount)}</div>
              <p className="text-xs text-muted-foreground mt-1">{paidPayments.length} ödeme tamamlandı</p>
            </CardContent>
          </Card>
                        ...
                        >
                          ...
                          <div className={`${viewMode === 'grid' ? 'space-y-2' : 'flex items-center gap-4'}`}>
                            <div className="text-right">
                              ...
                              <div className={`text-sm ${isOverdue ? 'text-red-700 font-semibold' : 'text-muted-foreground'}`}>
                                {isOverdue && '⚠️ '}
