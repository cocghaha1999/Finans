...
import { getLocalNotifications, persistLocalNotifications } from '@/lib/notifications'
import { useAuth } from '@/hooks/use-offline-auth'
import { getSyncStatus } from '@/lib/sync-manager'
...
import type { Transaction, AppNotification, DailyExpense } from '@/lib/types'
