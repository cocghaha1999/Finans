            ...
            <div className="flex-1 min-w-0 pr-2 sm:pr-4">
              <div className="flex items-center space-x-1 sm:space-x-2 mb-1">
                <Badge 
                  ...
                  className="text-[10px] sm:text-xs px-1 py-0.5"
                >
                  {transaction.type === "gelir" ? "Gelir" : "Gider"}
                </Badge>
                <span className="text-[10px] sm:text-xs text-muted-foreground truncate max-w-20 sm:max-w-none">
                  {transaction.category}
                </span>
              </div>
              
              <h4 className="font-medium text-xs sm:text-sm truncate mb-1 leading-tight">
