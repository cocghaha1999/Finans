...
export function CalendarFloat() {
  ...
  const loadMedia = () => {
    try {
      ...
      const map = raw ? safeJsonParse(raw, {} as Record<string, string>) : {}
        ...
        {!minimized && (
          <div className="p-3" style={{ width: size.w, height: size.h - 120 }}>
            ...
            <div className="mt-3 flex flex-wrap gap-x-3 gap-y-1 text-xs text-muted-foreground">
              <span className="inline-flex items-center gap-1.5"><span className="w-2.5 h-2.5 rounded-full bg-red-500"/> Gider</span>
              <span className="inline-flex items-center gap-1.5"><span className="w-2.5 h-2.5 rounded-full bg-blue-500"/> Ödeme</span>
              <span className="inline-flex items-center gap-1.5"><span className="w-2.5 h-2.5 rounded-full bg-purple-500"/> Ekstre</span>
              <span className="inline-flex items-center gap-1.5"><span className="w-2.5 h-2.5 rounded-full bg-orange-500"/> Son Ödeme</span>
              <span className="inline-flex items-center gap-1.5"><span className="w-2.5 h-2.5 rounded-full bg-green-500"/> Gelir</span>
            </div>
