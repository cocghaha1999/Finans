...
// Extract components safely to avoid missing named export issues during build
const { DayPicker, DayButton } = RDP as any
...
function Calendar({
  ...
  // Some versions of react-day-picker may not export getDefaultClassNames.
  // Guard it to prevent "Attempted import error" during build/export.
  const safeGetDefaultClassNames = (RDP as any).getDefaultClassNames as
    | (() => any)
    | undefined
  const defaultClassNames: any = safeGetDefaultClassNames
    ? safeGetDefaultClassNames()
    : {}
