...
const mockPayments: LocalPayment[] = [
  ...
  },
  {
    ...
    paymentType: 'fixed',
    updatedAt: new Date(),
    description: 'Mobil telefon faturası'
  },
  {
    id: '5',
    name: 'Araba Kredisi',
    ...
    paymentType: 'fixed',
    updatedAt: new Date(),
    description: 'Aylık araba kredisi taksiti'
  },
  {
    id: '6',
    ...
    paymentType: 'fixed',
    updatedAt: new Date(),
    description: 'Sağlık sigortası primi'
  }
]
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
          <Card className="bg-gradient-to-br from-blue-50 to-blue-100 border-blue-200">
            ...
            <CardContent>
              ...
              <p className="text-xs text-blue-600 mt-1">{payments.length} ödeme</p>
            </CardContent>
          </Card>
          ...
          <Card className="bg-gradient-to-br from-purple-50 to-purple-100 border-purple-200">
            ...
            <CardContent>
              ...
              <Progress 
                value={(paidPayments.length / payments.length) * 100} 
                className="mt-2"
              />
            </CardContent>
          </Card>
