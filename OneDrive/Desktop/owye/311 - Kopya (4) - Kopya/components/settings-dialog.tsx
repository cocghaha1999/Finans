...
export function SettingsDialog() {
  ...
  return (
    <Dialog open={open} onOpenChange={setOpen}>
      ...
      <DialogContent className="sm:max-w-[500px] md:max-w-4xl max-h-[90vh] overflow-auto">
        <DialogHeader>
          <DialogTitle className="flex items-center gap-2">
            <Settings className="h-5 w-5" />
            Ayarlar
          </DialogTitle>
          <DialogDescription>Uygulamanızı kendinize göre özelleştirin.</DialogDescription>
        </DialogHeader>
                ...
                <CardContent className="space-y-4">
                  <div className="flex items-center justify-between">
                    <div>
                      ...
                      <p className="text-sm text-muted-foreground">Tüm bildirimleri aç/kapat</p>
                    </div>
                    <Switch
                      id="notifications"
                  ...
                  <div className="flex items-center justify-between">
                    <div>
                      ...
                      <p className="text-sm text-muted-foreground">Eşik değeri değişince tekrar bildirim gönder</p>
                    </div>
                    <Switch
                  ...
                  <div className="flex items-center justify-between">
                    <div>
                      ...
                      <p className="text-sm text-muted-foreground">Harcama eşiğe eşit olduğunda da uyar</p>
                    </div>
                    <Switch
                      id="trigger-on-equal"
