...
const useFormField = () => {
  ...
  // Ensure fieldContext.name exists before using it  
  if (!fieldContext.name) {
    throw new Error("fieldContext.name is required")
  }
  ...
  try {
    ...
    throw new Error(`Form context error: ${error instanceof Error ? error.message : 'Unknown error'}`)
  }
