...
const mockNotifications: EnhancedNotification[] = [
  {
    id: "1",
    type: "payment",
    title: "Kredi kartı ödemesi yaklaşıyor",
    message: "Akbank kartınızın son ödeme tarihi 3 gün sonra. ₺1,250 ödeme yapmanız gerekiyor.",
  ...
  },
  {
    id: "2", 
    type: "budget",
    title: "Aylık bütçe %80 doldu",
    message: "Market kategorisinde aylık bütçenizin %80'ini kullandınız.",
  ...
  },
  {
    ...
    message: "Bu ay ₺500 tasarruf hedefini başarıyla tamamladın.",
