          ...
          <div className="flex items-center justify-between gap-1 overflow-hidden">
            <div className="flex items-center space-x-2 sm:space-x-8 min-w-0 flex-shrink">
              <div className="flex items-center space-x-1 sm:space-x-3 min-w-0">
                <img src="/logo.svg" alt="CostikFinans" className="h-6 w-6 sm:h-8 sm:w-8 flex-shrink-0" />
                <h1 className="text-sm sm:text-2xl font-bold text-foreground truncate">CostikFinans</h1>
              </div>
